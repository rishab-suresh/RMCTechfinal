...
const FAQ = () => {
  return (
    <div className="container mt-5 mb-5" id="faq">
      <section>
        <h1 class="text-center mb-4 pb-2 text-color-white fw-bold" id="faq-headingS">FAQ</h1>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <h6 class="mb-3 text-primary">
              <i class="far fa-paper-plane text-primary pe-2" id="icon"></i> A simple
              question?
            </h6>
            <p>
              <strong >
